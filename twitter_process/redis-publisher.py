...
if __name__ == '__main__':
    ...
    for msg in kafka_consumer:
        ...
        logger.info('Received new data from kafka: %s', record)

        redis_client.zincrby("tweet", int(record.get('Count')), record.get('word'))
